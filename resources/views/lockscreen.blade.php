            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-login" method="POST" action="{{ route('login') }}">
                  @csrf
                @if(Auth::user()->avatar == '')
                <p class="centered"><img class="img-circle" width="80" src="{{asset('assets/img/profil/default-avatar.png') }}"></p>
                @else
                <p class="centered"><img class="img-circle" width="80" src="{{asset('assets/img/profil/'. Auth::user()->avatar)}}"></p>
                @endif
